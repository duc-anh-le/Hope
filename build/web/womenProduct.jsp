                        ...
                        <div class="flex w-full justify-between">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a class="dropdown-item" href='${pageContext.request.contextPath}/womenProduct.jsp?value=high'>Low to high</a></li>
                                <li><a class="dropdown-item" href='${pageContext.request.contextPath}/womenProduct.jsp?value=low'>High to low</a></li>                                  
                            </ul>
                        </div>
                    </div>
