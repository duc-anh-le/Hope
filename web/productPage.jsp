                ...
                <div classname="body">
                        ...
                        <div class="flex w-full justify-between">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a class="dropdown-item" href='${pageContext.request.contextPath}/productPage.jsp?value=low'>Low to high</a></li>
                                <li><a class="dropdown-item" href='${pageContext.request.contextPath}/productPage.jsp?value=high'>High to low</a></li>                                  
                            </ul>
                        </div>
                    </div>
                    <div class="mt-6 grid grid-cols-4 gap-x-6 gap-y-10 sm:grid-cols-4 lg:grid-cols-4 xl:gap-x-8 xl:gap-y-8">
                        ...
                        <%
                            ...
                            List<Product> products = productDAO.getProductPage(pageNumber, pageSize, order);
